...
comments: true
tags: [indexing, lucene, Stack Overflow, Tag Engine]
...
I've added a [**Resources**]({{base}}/resources/) and [**Speaking**]({{base}}/speaking/) page to my site, check them out if you want to learn more.
